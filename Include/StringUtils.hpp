...
/**
 * @brief Removes C/C++ style inline (//) and block (/ * ... * /) comments from the stream, preserving string literals.
 *
 ...
 *
 * Unlike most strippers, this one won’t take your money or stink like a cigarette.
 *

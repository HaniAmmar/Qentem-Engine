/**
 * @file BigInt.hpp
 * @brief Implements arbitrary-precision integer arithmetic for Qentem Engine.
 *
 * This header defines the BigInt class, supporting integers of unlimited size
 * for mathematical operations that exceed standard fixed-width types. BigInt.hpp
 * provides essential functionality for cryptography, large number computations,
 * and any use case requiring precision beyond built-in integer types.
 *
 * @author Hani Ammar
 * @date 2025
